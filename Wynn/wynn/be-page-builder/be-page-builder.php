...
$row_controls = '<div class="be-pb-row-controls clearfix toggled">
					<div class="left row-column-controls">	
						<span class="rows-title">
					      ...
					      <a class="med-btn mini-btn-light btn-icon-one-col-wrap" title="Minus" role="button" data-col-name="one_col" data-col-count="1">
						      <span class="btn-icon-one-col">Full</span>
  						  </a>
  						  <a class="med-btn mini-btn-light btn-icon-one-half-wrap" title="Minus" role="button" data-col-name="one_half" data-col-count="2">
					      	<span class="btn-icon-one-half">One Half</span>
					      </a>
  						  <a class="med-btn mini-btn-light btn-icon-one-third-wrap" title="Minus" role="button" data-col-name="one_third" data-col-count="3">
					      	<span class="btn-icon-one-third">One Third</span>
					      </a>
  						  <a class="med-btn mini-btn-light btn-icon-one-fourth-wrap" title="Minus" role="button" data-col-name="one_fourth" data-col-count="4">
					      	<span class="btn-icon-one-fourth">One Fourth</span>
					      </a>
  						  <a class="med-btn mini-btn-light btn-icon-one-fifth-wrap" title="Minus" role="button" data-col-name="one_fifth" data-col-count="5">
					      	<span class="btn-icon-one-fifth">One Fifth</span>
					      </a>					      
  						  <a class="med-btn mini-btn-light btn-icon-two-third-wrap" title="Minus" role="button" data-col-name="two_third" data-col-count="2">
					      	<span class="btn-icon-two-third">Two third</span>
					      </a>
  						  <a class="med-btn mini-btn-light btn-icon-three-fourth-wrap" title="Minus" role="button" data-col-name="three_fourth" data-col-count="2">
					      	<span class="btn-icon-three-fourth">Three Fourth</span>
					      </a>
  						  <a class="med-btn mini-btn-light btn-icon-one-half-fourth-wrap" title="Minus" role="button" data-col-name="one_half_fourth" data-col-count="3">
...
$section_controls = '<div class="be-pb-section-controls clearfix toggled">
						<div class="section-header clearfix">
							...
							<div class="right section-controls">
								<a class="med-btn mini-btn-light" title="View" data-action="view">
									<span class="btn-icon-section-view"><i class="font-icon icon-eye"></i>View Row</span>
								</a>
								<a class="med-btn mini-btn-light" title="Minus" data-action="duplicate">
									<span class="btn-icon-section-duplicate"><i class="font-icon icon-duplicate icon-paste"></i>Duplicate Row</span>
								</a>
								...
								<a class="med-btn mini-btn-light" title="Minus" data-action="delete">
									<span class="btn-icon-section-delete"><i class="font-icon icon-cancel"></i>Delete Row</span>
								</a>
							</div>
						</div>
					</div>';
...
$blank_row = '<div class="be-pb-row-wrap be-pb-element clearfix">
						...
						<div class="be-pb-row be-pb-sortable clearfix">
							<div class="be-pb-col-wrap one_col" data-col-name="one_col">
								...
								<div class="be-pb-controls"><a class="mini-btn mini-btn-dark choose-shortcode" title="Add" role="button"><span class="btn-icon-plus"><i class="font-icon icon-plus"></i>Add</span></a></div>
							</div>	
						</div>
...
$blank_section = '<div class="be-pb-section-wrap be-pb-element clearfix">
								...
								<div class="be-pb-section-inner-wrap"><div class="be-pb-section">
									'.$blank_row.'
								</div><a href="#" class="bluefoose-button-dark be-pb-add-row">+ Row</a></div>
...
function get_multi_shortcode_block($shortcode_name, $output = '', $inner_shortcode =''){
	...
	$html = '';
	$html .= '<div class="be-pb-multi-wrap be-pb-element toggled" data-shortcode="'.$shortcode_name.'">';
	$html .= '<pre class="shortcode">'.$output.'</pre>';
	$html .= '<div class="be-pb-multi-fields-header-wrap clearfix"><h4>'.$be_shortcode[$shortcode_name]['name'].'<span class="be-pb-control-icon icon-cancel-circled icon-delete icon-trash bottom-border" title="Delete"></span><span class="be-pb-control-icon icon-book icon-duplicate icon-paste bottom-border" title="Duplicate"></span><span class="be-pb-control-icon icon-pencil edit-shortcode '.$hide.' clear" title="Edit" data-shortcode="'.$shortcode_name.'" data-action="edit"></span><span class="be-pb-control-icon icon-eye" title="View"></span></h4></div>';
	...
	$html .= '</div>';
	$html .= '<div class="be-pb-controls"><a class="mini-btn mini-btn-dark add-multi-field" title="Add" role="button" data-single-field='.$be_shortcode[$shortcode_name]['single_field'].'><span class="btn-icon-plus"><i class="font-icon icon-plus"></i>Add</span></a>';
	$html .= '</div></div>';
	return $html;
}
...
function get_single_shortcode_block($shortcode_name, $output = ''){
	...
	$html .= '<div class="portlet-header"><div class="portlet-header-controls-wrap right"><span class="be-pb-control-icon icon-cancel-circled icon-delete icon-trash bottom-border" title="Delete"></span><span class="be-pb-control-icon icon-book icon-duplicate icon-paste bottom-border" title="Duplicate"></span><span class="be-pb-control-icon icon-pencil icon-edit edit-shortcode '.$hide.' clear" title="Edit" data-shortcode="'.$shortcode_name.'" data-action="edit"></span><span class="be-pb-control-icon icon-eye" title="View"></span></div>'.$be_shortcode[$shortcode_name]['name'].'</div>';
	...
	function be_page_builder_custom_box() {
		...
		<div id="shortcodes" title="Modules" style="display:none;" class="be-jq-dialog">
			<div class="shortcode-description clearfix">
				<h4><?php _e('Structure','be-themes') ?></h4>
				<p><?php _e('These are optional but important modules which you can use to build up the structure of the page. Click on one of these modules to add them to the page builder.','be-themes') ?></p>
  			</div>
			<?php 
			...
			<div class="shortcode-btn-wrap">
				<?php
					foreach ($be_sorted_shortcode as $shortcode_key => $shortcode) {
						...
						if(!empty($shortcode['module_type']) && $shortcode['module_type'] == 'structure' && $shortcode['type'] != 'multi_single' && $shortcode_key != 'section' && $shortcode_key != 'row') {
		...
		<div id="be-page-builder-controls"> <a href="#" class="bluefoose-button-dark" id="be-pb-add-section">+ Section</a></div>
...
function be_pb_do_shortcode_tag($m){
	...
	if($m[2] == 'section'){
		return '<div class="be-pb-section-wrap be-pb-element clearfix">
					'.$section_controls.'
					<div class="be-pb-section-inner-wrap"><div class="be-pb-section">'.be_pb_do_shortcode($m[5]).'</div><a href="#" class="bluefoose-button-dark be-pb-add-row">+ Row</a></div>
	...
	elseif(array_key_exists($m[2], $be_shortcode) && $be_shortcode[$m[2]]['type']== 'multi') {
		...
		return 	 '<div class="be-pb-multi-wrap be-pb-element toggled" data-shortcode="'.$m[2].'">
				<pre class="shortcode">['.$m[2].$m[3].']</pre>
				<div class="be-pb-multi-fields-header-wrap clearfix"><h4>'.$be_shortcode[$m[2]]['name'].'<span class="be-pb-control-icon icon-cancel-circled icon-delete icon-trash bottom-border" title="Delete"></span><span class="be-pb-control-icon icon-book icon-duplicate icon-paste bottom-border" title="Duplicate"></span><span class="be-pb-control-icon icon-pencil edit-shortcode '.$hide.' clear" title="Edit" data-shortcode="'.$m[2].'" data-action="edit"></span><span class="be-pb-control-icon icon-eye" title="View"></span></h4></div>
		 <div class="be-pb-multi-fields-wrap"><div class="be-pb-multi-fields be-pb-shortcode-col be-pb-sortable">'.be_pb_do_shortcode($m[5]).'
		 </div>
		 <div class="be-pb-controls"><a class="mini-btn mini-btn-dark add-multi-field" title="Add" role="button" data-single-field='.$be_shortcode[$m[2]]['single_field'].'><span class="btn-icon-plus"><i class="font-icon icon-plus"></i>Add</span></a>
		 </div></div></div>';
	}	
