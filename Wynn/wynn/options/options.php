...
class NHP_Options{
	...
	*/
	function __construct($sections = array(), $args = array(), $extra_tabs = array()){
		...
		$defaults['footer_credit'] = '<span id="footer-thankyou">'.__('Wynn Options', 'be-themes').'</span>';
